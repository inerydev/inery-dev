---
content_title: INE Wallet Specification
---

## INE Wallet Import Format (WIF)

Wallet Import Format is an encoding for a private EDSA key.  INE uses the same version, checksum, and encoding scheme as the Bitcoin WIF addresses and should be compatible with existing libraries [1].
...
Base58Check is a JavaScript implementation of this algorithm and may be used to encode and decode INE WIF private keys.
