...
```console
Usage: cline set action [OPTIONS] SUBCOMMAND
...
cline set action permission sandwichfarm inery.system voteproducer voting -p sandwichfarm@voting

#Now can execute the transaction with the previously set permissions. 
cline system voteproducer approve sandwichfarm someproducer -p sandwichfarm@voting
```
