...
## Command
A set of INERY keys is required to create an account. The INERY keys can be generated by using `cline create key`.

```sh
cline create account inita tester INE4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq INE7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
