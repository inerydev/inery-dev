...
- `sender` _TEXT_ - The account sending INE
- `recipient` _TEXT_ - The account receiving INE
- `amount` _UINT_ - The amount of INE to send
...
```sh
cline transfer inita tester 1000
```
