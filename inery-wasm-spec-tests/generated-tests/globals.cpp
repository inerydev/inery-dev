...
const string wasm_str_globals_0 = base_dir + "/inery-wasm-spec-tests/generated-tests/wasms/globals.0.wasm";
...
const string wasm_str_globals_17 = base_dir + "/inery-wasm-spec-tests/generated-tests/wasms/globals.17.wasm";
