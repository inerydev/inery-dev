...
void test_print::test_printn() {
   printn(inery::name{"1"}.value);
   printn(inery::name{"5"}.value);
   printn(inery::name{"a"}.value);
   printn(inery::name{"z"}.value);

   printn(inery::name{"abc"}.value);
   printn(inery::name{"123"}.value);

   printn(inery::name{"abc.123"}.value);
   printn(inery::name{"123.abc"}.value);

   printn(inery::name{"12345abcdefgj"}.value);
   printn(inery::name{"ijklmnopqrstj"}.value);
   printn(inery::name{"vwxyz.12345aj"}.value);

   printn(inery::name{"111111111111j"}.value);
   printn(inery::name{"555555555555j"}.value);
   printn(inery::name{"aaaaaaaaaaaaj"}.value);
   printn(inery::name{"zzzzzzzzzzzzj"}.value);
}
