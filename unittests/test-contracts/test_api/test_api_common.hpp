...
struct dummy_action {
   static uint64_t get_name() {
      return inery::name{"dummy_action"}.value;
   }
   static uint64_t get_account() {
      return inery::name{"testapi"}.value;
   }
...
struct u128_action {
  ...
  INELIB_SERIALIZE( u128_action, (values) )
};

struct cf_action {
   static uint64_t get_name() {
      return inery::name{"cf_action"}.value;
   }
   static uint64_t get_account() {
      return inery::name{"testapi"}.value;
   }
   ...
   INELIB_SERIALIZE( cf_action, (payload)(cfd_idx) )
};
...
struct dtt_action {
   ...
   INELIB_SERIALIZE( dtt_action, (payer)(deferred_account)(deferred_action)(permission_name)(delay_sec) )
};
...
struct invalid_access_action {
   ...
   INELIB_SERIALIZE( invalid_access_action, (code)(val)(index)(store) )
};
