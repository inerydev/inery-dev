...
extern "C" {
   void apply( uint64_t receiver, uint64_t code, uint64_t action ) {
      if( code == "inery"_n.value && action == "onerror"_n.value ) {
         auto error = inery::onerror::from_current_action();
         inery::print("onerror called\n");
      ...
      //unhandled test call
      inery_assert( false, "Unknown Test ahhh!" );
