...
class [[inery::contract]] get_table_test : public inery::contract {
    public:
    using inery::contract::contract;

    // Number object
    struct [[inery::table]] numobj {
        uint64_t        key;
        uint64_t        sec64;
        uint128_t       sec128;
        double          secdouble;
    ...
    typedef inery::multi_index< "numobjs"_n, numobj, 
    ...
    typedef inery::multi_index< "hashobjs"_n, hashobj, 
