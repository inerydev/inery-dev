...
( [[ $PIN_COMPILER == false ]] && [[ $VERSION_ID == "18.04" ]] || 1) && EXTRA_DEPS=(clang,dpkg\ -s llvm-7-dev,dpkg\ -s)
...
( [[ $VERSION_ID == "16.04" ]] || 1 || ( $PIN_COMPILER && [[ $VERSION_ID == "18.04" ]] ) ) && ensure-build-essential
